...
ActiveRecord::Schema.define(version: 20170518161455) do
  ...
  create_table "cars", force: :cascade do |t|
    ...
    t.integer  "train_id"
    t.integer  "lateral_top_seats"
    t.integer  "lateral_bottom_seats"
    t.integer  "seat_places"
    t.string   "type"
    t.integer  "in_train_index"
